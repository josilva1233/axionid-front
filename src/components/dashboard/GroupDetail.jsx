      ...
      <div className="permissions-section">
        <div className="info-card">
          <div className="permissions-header">
            <h4 className="card-title">Chaves de Permissão (ACL)</h4>
            <select
              className="custom-input-dark permission-select"
              onChange={(e) => {
                ...
                {group.permissions?.length > 0 ? (
                  group.permissions.map((perm) => (
                    <tr key={perm.id}>
                      ...
                      <td><strong className="text-white text-uppercase">{perm.label}</strong></td>
                      <td><code className="permission-code">{perm.name}</code></td>
                      <td><span className="badge-operacional">IAM</span></td>
