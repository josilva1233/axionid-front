...
export default function GroupForm({ onSave, onCancel, loading }) {
  ...
  return (
    <div className="group-form-container animate-in p-4 mb-4" style={{ background: "rgba(255,255,255,0.03)", borderRadius: "12px", border: "1px solid var(--border-color)" }}>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <div className="d-flex gap-2">
          ...
          <button type="button" className="btn-filter-clear" onClick={onCancel} disabled={loading}>
            Cancelar
          </button>
        </div>
      </Form>
